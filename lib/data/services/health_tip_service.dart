  ...
  List<HealthTip> _getHardcodedHealthTips() {
    return [
      HealthTip(
        ...
        content:
            'Ensure your dog gets a balanced diet with proper proteins, carbohydrates, and vegetables. Avoid feeding chocolate, grapes, and onions as they can be toxic to dogs.',
      ...
      HealthTip(
        ...
        content:
            'Dogs need regular exercise to maintain their physical and mental health. The amount varies by breed, age, and health status. Most dogs benefit from at least 30 minutes of activity daily.',
      ...
      HealthTip(
        ...
        title: 'Dental Care',
        content:
            'Regular tooth brushing can prevent dental disease in dogs. Aim for daily brushing using dog-specific toothpaste (never human toothpaste).',
      ...
      HealthTip(
        ...
        content:
            'Maintaining a regular parasite prevention schedule is essential for your dog\'s health. This includes flea, tick, heartworm, and intestinal parasite prevention.',
      ...
      HealthTip(
        ...
        content:
            'Early detection of illness is important. Watch for changes in appetite, water consumption, energy levels, urination, bowel movements, vomiting, or unusual behaviors.',
